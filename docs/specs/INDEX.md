...
|---|---------|-------------|--------|-------|-----|------------|
| [001](001-perceive-phase.md) | Perceive Phase (PPER) | §3, §4, §5, §6, §11 | 🔍 In Review | [#1](https://github.com/Redna/evol-hive/issues/1) | — | engine, cognition, shared |
...
| [§6](../architecture/06-pper-loop.md) | PPER Loop | 001 (Perceive) | 🔍 Perceive in review |
