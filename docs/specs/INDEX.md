...
| [039](039-spatial-phase2-area-intents-cell-fog.md) | Spatial Navigation Phase 2 — `targetArea` Intents, Cell-Level Fog, Social Fog-Lifting, Determinism (spec 038 remainder) | §2, §3, §6, §9 | 📝 Drafted | [#144](https://github.com/Redna/evol-hive/issues/144) | — | shared, engine, cognition, visualizer |
