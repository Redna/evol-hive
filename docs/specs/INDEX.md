...
| [051](051-enum-bound-talk-targets.md) | Enum-Bound Conversation Targeting — `talk_to` Target Becomes a Per-Cycle Enum of Present, Uncapped Agent IDs (Closes the Free-Choice Talk Loop) | §2, §7, §8 | 📝 Drafted | [#186](https://github.com/Redna/evol-hive/issues/186) | — | shared, engine, cognition |
