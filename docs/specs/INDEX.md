...
| [§4](../architecture/04-smart-objects.md) | Smart Objects & Affordances | 001, 003, 008, 013, 018, 019, 022, 031, 032, 033, 058 | ✅ Implemented |
...
| [§6](../architecture/06-pper-loop.md) | PPER Loop | 001-004, 006, 008, 012, 017, 025, 026, 031, 032, 033, 057, 058 | ✅ Implemented |
| [§7](../architecture/07-structured-outputs.md) | Structured Outputs | 011 (tool calling), 019 (affordance-as-tools), 025, 026, 058 | ✅ Implemented |
...
| [§10](../architecture/10-cognitive-guardrails.md) | Cognitive Guardrails | 016, 019, 030, 031, 033, 057, 058 | ✅ Implemented |
...
| [039](039-spatial-phase2-targetarea-fog.md) | Spatial Phase 2 — `targetArea` LLM Intents, Cell-Level Fog, Social Fog-Lifting, Determinism & QA | §2, §3, §6, §7, §9 | 🔍 In Review | [#144](https://github.com/Redna/evol-hive/issues/144) | [#148](https://github.com/Redna/evol-hive/pull/148) | shared, engine, cognition, visualizer, examples |
| [040](040-idle-tick-memory-suppression.md) | Idle-Tick Memory Suppression — Wait-Only Cycles Store Nothing (Third System 1 Label Domino) | §6, §11 | 🔍 In Review | [#149](https://github.com/Redna/evol-hive/issues/149) | [#151](https://github.com/Redna/evol-hive/pull/151) | cognition, engine |
| [041](041-applied-drive-changes-label.md) | Applied-DriveChanges Outcome Labeling — Cycle-Length Decay Defeats Snapshot Diffing (Fourth System 1 Label Domino) | §5, §6 | 🔍 In Review | [#152](https://github.com/Redna/evol-hive/issues/152) | [#154](https://github.com/Redna/evol-hive/pull/154) | shared, cognition, engine |
...
| [051](051-enum-bound-talk-targets.md) | Enum-Bound Conversation Targeting — `talk_to` Target Becomes a Per-Cycle Enum of Present, Uncapped Agent IDs (Closes the Free-Choice Talk Loop) | §2, §7, §8 | 🔍 In Review | [#186](https://github.com/Redna/evol-hive/issues/186) | [#188](https://github.com/Redna/evol-hive/pull/188) | shared, engine, cognition |
