...
| [010](010-llm-schema-in-prompt-and-field-aliasing.md) | LLM Schema-in-Prompt & Field Name Aliasing | §6, §7, §9 | 🔍 In Review | [#37](https://github.com/Redna/evol-hive/issues/37) | [#39](https://github.com/Redna/evol-hive/pull/39) | cognition, shared |
...
| [§7](../architecture/07-structured-outputs.md) | Structured Outputs | 002 (partial), 004 (reflectSchema), 006 (OpenAI response_format, memoryConsolidationSchema), 009 (JSON recovery, json_object fallback), 010 (schema-in-prompt, field aliasing) | 📝 Partial — full spec needed |
