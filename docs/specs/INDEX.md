...
| [034](034-drive-affordance-hints-hunger-chain.md) | Drive→Affordance Matching Hints + Hunger Restoration Chain — Close the Drive-Hint Gap & the Plant→Eat Loop | §3, §4, §6, §8 | 📝 Drafted | [#130](https://github.com/Redna/evol-hive/issues/130) | — | cognition, examples |
