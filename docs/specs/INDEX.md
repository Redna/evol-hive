...
| [008](008-pper-error-recovery.md) | Error Recovery & Edge Cases in PPER Loop | §3, §6, §9, §10 | 📝 Drafted | [#23](https://github.com/Redna/evol-hive/issues/23) | — | shared, engine, cognition |
...
| [§6](../architecture/06-pper-loop.md) | PPER Loop | 001 (Perceive), 002 (Plan), 003 (Execute), 004 (Reflect), 006 (LLM client), 008 (error recovery) | 🔍 Perceive in review; 🔍 Plan in review; 🔍 Execute in review; 🔍 Reflect in review; 📝 Error recovery drafted |
...
| [§9](../architecture/09-engine-routing.md) | Engine Routing | 002 (partial — isThinking), 003 (isThinking, feedback), 004 (isThinking), 006 (LLM error propagation), 008 (cycle retry, stuck detection) | 📝 Partial — full spec needed |
| [§10](../architecture/10-cognitive-guardrails.md) | Cognitive Guardrails | 008 (stuck detection, edge states) | 📝 Partial — full spec needed |
