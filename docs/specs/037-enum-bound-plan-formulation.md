...
4. **Parameter boundary (Req 3)**: enum constrains *values only*. No nested per-step args — handlers resolve concrete targets at execute time (spec 031 co-location guard validates).
